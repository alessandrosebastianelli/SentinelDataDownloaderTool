...
class PreviewWidget(Frame):
    def __init__(self,master,label="",**kw):
        ...
        dataset_path = os.path.join(os.path.abspath(os.getcwd()),'dataset')
        s2_paths, s2_zones = image_loader.get_images_path(dataset_path, 'sen2')
        s1_images, s1_zones = image_loader.get_images_path(dataset_path, 'sen1')
