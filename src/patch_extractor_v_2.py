...
if windows:
    ...
    preview_path = 'C:\\Users\\Phicollaborator\\Desktop\\downloader_tool\\code\\dataset_patch\\preview\\'
else:
    ...
    preview_path = '/home/sebbyraft/Desktop/downloader_tool/code/dataset_patch/preview/'
...
for i in range(len(s2_locations)):
    fig, axes = plt.subplots(nrows = 24, ncols=20, figsize = (100,100))
    # Get S1 and S2 scene
    ...
    if s2_locations[i] == s1_locations[i]:
        ...
        date_generator = iter(cleaner_v_2.split_by_date(s1_scene, date_names))
