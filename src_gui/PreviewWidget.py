...
class PreviewWidget(Frame):
    def __init__(self,root):
        ...
        s2_paths, s2_zones = image_loader.get_images_path('/Users/alessandrosebastianelli/Desktop/SentinelDataDownloaderTool/src_gui/dataset/', 'sen2')
        s1_images, s1_zones = image_loader.get_images_path('/Users/alessandrosebastianelli/Desktop/SentinelDataDownloaderTool/src_gui/dataset/', 'sen1')
